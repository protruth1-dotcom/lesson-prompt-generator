        ...
        sections: {
          ...
          practiceTogether: {
            items: [
              ...
              { number: 2, prompt: 'Compare 3/8 and 1/3 by finding a common denominator. Use the number line to check your answer.', hint: 'Find the least common multiple of 8 and 3.', partialAnswer: 'Multiples of 8: 8, 16, [[24]]... Multiples of 3: 3, 6, 9, 12, 15, 18, 21, [[24]]...', answer: '3/8 = 9/24 and 1/3 = 8/24, so 3/8 > 1/3', explanation: 'With common denominator 24: 9/24 is greater than 8/24. On the number line, 3/8 lands at 0.375 and 1/3 at about 0.333.', diagramType: 'number-line', diagramData: { points: [{ position: 0.333, label: [1, 3] }, { position: 0.375, label: [3, 8] }] } },
            ],
          },
          onYourOwn: {
            items: [
