        ...
        sections: {
          ...
          practiceTogether: {
            items: [
              ...
              { number: 3, prompt: 'A student named Jordan wrote about a school play they performed in. Their younger sibling, who watched from the audience, also wrote about the play. Which account is firsthand for the experience of performing?', hint: 'Who was actually on stage?', partialAnswer: 'Jordan was on stage performing, so their account of performing is firsthand. The sibling...', answer: 'Jordan was the performer so their account of performing is firsthand. The sibling watched from the audience.', explanation: 'A firsthand account depends on who experienced what. Jordan experienced performing directly.' },
            ],
          },
          onYourOwn: {
            items: [
        ...
        sections: {
          ...
          learnModel: {
            ...
            blocks: [
              ...
              { type: 'diagram', diagramType: 'fraction-bar', placeholderInstruction: 'Draw fraction bars for 2/3 and 3/4. Shade 2 out of 3 equal parts for 2/3 and 3 out of 4 equal parts for 3/4. Which bar has more shaded area?', caption: 'Compare 2/3 and 3/4 using fraction bars. The 3/4 bar has more shaded area, so 3/4 is greater.' },
          ...
          practiceTogether: {
            items: [
              { number: 1, prompt: 'Compare 1/2 and 2/5. Use the number line below. Which fraction is greater?', hint: 'Find where each fraction lands between 0 and 1.', answer: '1/2 is greater than 2/5', explanation: '1/2 = 0.50 and 2/5 = 0.40. On a number line, 1/2 is farther right, so it is greater.', diagramType: 'number-line', diagramData: { points: [{ position: 0.4, label: [2, 5] }, { position: 0.5, label: [1, 2] }] } },
              { number: 2, prompt: 'Compare 3/8 and 1/3 by finding a common denominator. Use the number line to check your answer.', hint: 'List the multiples of each denominator. Find the smallest number that appears in both lists.', partialAnswer: 'Multiples of 8: 8, 16, ____, 32, 40, 48\nMultiples of 3: 3, 6, 9, 12, 15, 18, 21, ____, 27, 30\nCommon denominator: ____', answer: '3/8 = 9/24 and 1/3 = 8/24, so 3/8 > 1/3', explanation: 'With common denominator 24: 9/24 is greater than 8/24. On the number line, 3/8 lands at 0.375 and 1/3 at about 0.333.', diagramType: 'number-line', diagramData: { points: [{ position: 0.333, label: [1, 3] }, { position: 0.375, label: [3, 8] }] } },
            ],
          },
          onYourOwn: {
            items: [
          ...
          quiz: {
            ...
            questions: [
              ...
              { number: 5, questionType: 'labeling', question: 'Draw a number line from 0 to 1. Mark and label: 1/2, 2/3, 3/4. Write the fractions in order from least to greatest.', labels: ['1/2', '2/3', '3/4'], answer: '1/2 < 2/3 < 3/4', diagramDescription: 'Draw your number line here. Mark three points.', diagramType: 'number-line', diagramData: { points: [{ position: 0.5, label: null }, { position: 0.667, label: null }, { position: 0.75, label: null }] } },
            ],
            answerKey: [
    ...
    '4th Grade': {
      'Relationship between speed of an object and its energy': {
        ...
        sections: {
          ...
          practiceTogether: {
            items: [
              { number: 1, prompt: 'Look at the data table. To move the cup exactly 60 cm, should the marble be released higher or lower than 30 cm? Explain.', hint: 'Each 10 cm increase adds about 16-23 cm to the cup distance.', answer: 'Higher than 30 cm. The pattern shows each 10 cm adds distance. From 51 cm to 60 cm needs about 5-6 cm more height, so about 35-36 cm.' },
              { number: 2, prompt: 'A bowling ball and tennis ball roll at the SAME speed toward pins. Which knocks down more pins? Why?', hint: 'Think about mass as well as speed.', partialAnswer: 'The bowling ball has more mass, so at the same speed...', answer: 'The bowling ball has more mass, so it has more kinetic energy at the same speed and knocks down more pins.' },
            ],
          },
          onYourOwn: {
            items: [
        ...
        sections: {
          ...
          practiceTogether: {
            items: [
              ...
              { number: 2, prompt: 'The President appoints a Supreme Court justice. The Senate votes whether to approve. Which two branches are involved? How is this checks and balances?', hint: 'President = Executive. Senate = Legislative.', answer: 'Executive appoints, Legislative approves. This is checks and balances because the President cannot put anyone on the Court without Congress agreeing.' },
            ],
          },
          onYourOwn: {
            items: [
        ...
        sections: {
          ...
          learnModel: {
            ...
            blocks: [
              ...
              { type: 'text', text: '1. [[Those who believe]] -- Having true faith in Allah\n2. [[Those who do righteous deeds]] -- Acting on faith with good actions\n3. [[Those who advise each other to truth]] -- Encouraging others to do right\n4. [[Those who advise each other to patience]] -- Supporting each other when things are hard' },
          ...
          practiceTogether: {
            items: [
              ...
              { number: 2, prompt: 'Your friend is about to copy someone homework. Which quality from Surah Al-Asr guides you to tell them not to?', hint: 'Advising each other to truth means helping others do what is right.', answer: 'Advising each other to truth. Telling your friend not to copy is encouraging them to do the right thing.' },
            ],
          },
          onYourOwn: {
            items: [
