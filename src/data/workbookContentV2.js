    ...
    '4th Grade': {
      'Compare two fractions with different numerators and denominators': {
        ...
        sections: {
          ...
          practiceTogether: {
            items: [
              { number: 1, prompt: 'Compare 1/2 and 2/5. Draw two number lines of the same length. Mark 1/2 on the first and 2/5 on the second. Which is greater?', hint: 'Split one line into halves, the other into fifths.', answer: '1/2 is greater than 2/5', explanation: 'On a number line, 1/2 lands at 0.50 and 2/5 lands at 0.40. So 1/2 is farther right.' },
              { number: 2, prompt: 'Compare 3/8 and 1/3 by finding a common denominator. Show your work.', hint: 'Find the least common multiple of 8 and 3.', partialAnswer: 'Multiples of 8: 8, 16, [[24]]... Multiples of 3: 3, 6, 9, 12, 15, 18, 21, [[24]]...', answer: '3/8 = 9/24 and 1/3 = 8/24, so 3/8 > 1/3', explanation: 'With common denominator 24: 9/24 is greater than 8/24.' },
            ],
          },
          onYourOwn: {
            items: [
